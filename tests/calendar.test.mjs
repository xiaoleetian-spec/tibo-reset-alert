...
test('RESET calendar marks confirmed, banked, planned and latest dates',()=>{
  const state={history:[post(4,4,'completed','All reset for everyone.'),post(5,5,'related','Banked resets were affected. Everyone is getting another one.'),post(7,7,'planned','We will reset Codex tomorrow.'),post(8,8,'completed','Codex reset done.')],recent:[post(4,4,'completed','duplicate')],lastReset:post(8,8,'completed','Codex reset done.')};
