...
for(const file of ['manifest.json','background.js','workspace.js','panel.html','alarm.html','privacy.html','offscreen.html','offscreen.js','ui.js','ui.css','icon.png','content.js','parser.js','core.js']) {
